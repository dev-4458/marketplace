 ...
 */
class Sandy_Marketplace_Model_Vendor_Attribute_Backend_File extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    ...
    public function afterSave($object)
    {
        ...
        $path = Mage::helper('sandy_marketplace/vendor')->getFileBaseDir();
