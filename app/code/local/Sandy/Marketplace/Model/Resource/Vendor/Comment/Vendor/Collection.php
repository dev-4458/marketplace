 ...
 */
class Sandy_Marketplace_Model_Resource_Vendor_Comment_Vendor_Collection extends Sandy_Marketplace_Model_Resource_Vendor_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('sandy_marketplace/vendor_comment_store');
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('sandy_marketplace/vendor_comment');
        $this->addAttributeToSelect('shopurl');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.vendor_id = e.entity_id',
            array(
                'ct_title'      => 'title',
