 ...
 */
class Sandy_Marketplace_Block_Adminhtml_Marketplace_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('sandy_marketplace/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Sandy_Marketplace_Model_Resource_Eav_Attribute
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @return Sandy_Marketplace_Block_Adminhtml_Marketplace_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('sandy_marketplace')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('sandy_marketplace')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('sandy_marketplace')->__('[STORE VIEW]');
        }
        return $html;
    }
